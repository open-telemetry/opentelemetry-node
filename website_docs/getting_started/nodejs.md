...
const { SimpleSpanProcessor, ConsoleSpanExporter } = require("@opentelemetry/sdk-base-tracing");
...
```shell
npm install --save @opentelemetry/sdk-node-tracing @opentelemetry/auto-instrumentations-node
```
